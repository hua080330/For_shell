...
# Commands: list, search, dl, bg, jobs, fg, stop, set, show, save, use, add, repos, muldl, info, help
# ============================================================
...
function Get-TabCompletion {
    ...
    $knownCommands = @("list", "ls", "search", "src", "download", "dl", "bg", "jobs", "fg", "stop", "kill", "info", "set", "show", "save", "use", "add", "repos", "muldl", "clear", "cls", "help", "?", "exit", "quit")
